...
If you already know some of the material:

- you can skip ahead
- the material builds on itself, so you do need to know the previous content to move forward
- but, if you know it, the projects and review questions should be quick
- and you can check that you have a solid grasp on what you need to know
- so, one strategy is to just do the projects, questions, and exercises, and read and watch the
  videos when you get stuck.
